...
DockSpace     ID=0x782A6D6B Window=0xDEDC5B90 Pos=0,25 Size=1920,1174 Split=X
  DockNode    ID=0x00000002 Parent=0x782A6D6B SizeRef=549,1174 Split=Y Selected=0xE3280322
    DockNode  ID=0x00000001 Parent=0x00000002 SizeRef=549,587 Selected=0xE3280322
    DockNode  ID=0x00000004 Parent=0x00000002 SizeRef=549,585 Selected=0x5098EBE6
